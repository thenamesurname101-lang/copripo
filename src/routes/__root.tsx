  ...
  head: () => ({
    meta: [
      ...
      { title: "Country Pride Poultry — Where Freshness Takes Flight" },
      {
        name: "description",
        content:
          "Country Pride Poultry (CoPriPo) supplies fresh broilers, dressed chickens, eggs, day-old chicks and quality poultry feed. Order in Karoi today.",
      },
      { name: "author", content: "Country Pride Poultry" },
      { name: "theme-color", content: "#1e4d2b" },
      { property: "og:title", content: "Country Pride Poultry — Where Freshness Takes Flight" },
      {
        property: "og:description",
        content:
          "Fresh, hygienic, affordable poultry products direct from our farm in Karoi. Book your order via WhatsApp.",
      },
